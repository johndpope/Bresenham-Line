...
//              let encodedAngle = encodeAngle(angle,"cossin")
        ...
        do{
            ...
            let radialImageByteArrayCount = trainImages[0].count // will correspond to the 5 radial cuts radii flattened
            
            let network = Network(layerStructure: [radialImageByteArrayCount,500,1], activationFunction: sigmoid, derivativeActivationFunction: derivativeSigmoid, learningRate: 0.006, hasBias: true)
